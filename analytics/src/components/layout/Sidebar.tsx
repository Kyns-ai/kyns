...
const nav = [
  ...
  { href: '/dashboard/retention', label: 'Retenção', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
  { href: '/dashboard/features', label: 'Features', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-56 shrink-0 bg-surface-800 border-r border-white/5 flex flex-col h-screen sticky top-0">
      <div className="px-4 py-5 border-b border-white/5">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-sm font-bold text-white">KYNS</p>
