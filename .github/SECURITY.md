...
- **Option 3: Email**: You can reach us at contact@kyns.ai. Please ensure that initial contact does not include any sensitive details in plain text.
...
We are committed to maintaining the security of our open-source project, KYNS, and promptly addressing any identified vulnerabilities. To ensure the security of our project, we adhere to the following practices:
...
- Repository: [KYNS](https://github.com/Kyns-ai/kyns)

## Contact

If you have any questions or concerns regarding the security of our project, please reach out via email at contact@kyns.ai or by [opening an issue](https://github.com/Kyns-ai/kyns/issues/new) on GitHub. Please note that the response time may vary depending on the nature and severity of the inquiry.
