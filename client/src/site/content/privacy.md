...
- Não usamos o conteúdo das conversas para analytics, publicidade, perfilamento ou qualquer finalidade secundária. Filtros automatizados de segurança processam as mensagens em tempo real para prevenção de conteúdo ilegal (CSAM), sem armazenamento do conteúdo analisado;
...
- **Log Data:** endereço IP, tipo de navegador, configurações, data e hora das requisições e como você interage com os Serviços. IPs são usados para limitação de taxa, prevenção de abuso e registrados em logs de erro (retidos por até 30 dias);
...
- Endereços IP: usados para limitação de taxa e registrados em logs de erro por até 30 dias para diagnóstico técnico;
...
## 10. Usuários internacionais e LGPD
...
**Para usuários no Brasil — Lei Geral de Proteção de Dados (LGPD):** em conformidade com a Lei nº 13.709/2018, você tem direito a: acessar, corrigir, anonimizar, bloquear ou eliminar dados pessoais desnecessários, excessivos ou tratados em desconformidade; solicitar portabilidade de dados; revogar consentimento a qualquer momento; e obter informações sobre entidades públicas e privadas com as quais compartilhamos dados. Todas as solicitações podem ser feitas via `contact@kyns.ai`. Para questões não resolvidas, você pode entrar em contato com a Autoridade Nacional de Proteção de Dados (ANPD) em [gov.br/anpd](https://www.gov.br/anpd).
