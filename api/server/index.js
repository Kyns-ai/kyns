...
const { startKynsDataRetention } = require('./services/kynsDataRetention');
...
const startServer = async () => {
  ...
  app.use((req, res, next) => {
    ...
    res.setHeader(
      ...
      "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://challenges.cloudflare.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self' data:; connect-src 'self' https: wss:; frame-src https://challenges.cloudflare.com; object-src 'none'; base-uri 'self';",
    );
    next();
  });
